...
// o'zbekcha
$botman->hears('(.*)Ўзбекча',function ($bot) {
    $keyboard = [
        ['Вилоятлар'],
        ['Тузилмалар'],
        ['Universitetlar'],
...
$botman->hears('(.*)На русском',function ($bot) {
    ...
    $bot->reply('🗣 Уважаемые граждане! Если вы столкнетесь с коррупцией в системе Минсельхоза, сообщите нам об этом.
        ...
        ‼️ Отправленные сообщения будут рассмотрены в установленном порядке, и конфиденциальность заявителя будет гарантирована.',['reply_markup' => json_encode([
        'keyboard' => $keyboard,
        'one_time_keyboard' => true,
        'resize_keyboard' => true
    ])]);
...
// $botman->hears('.*📩Послать сообщение.*', function($bot){
//     $bot->typesAndWaits(0);
//     $bot->reply('');
//     if ('notog\'ri') {
//         # code...
...
$botman->hears('Мурожатларни кўриб чиқиш ва ижро интизоми бўйича', function($bot){
    ...
    $botman->hears('Андижанская область|Бухарская область|Джизакская область|Кашкадарьинская область|Республика Каракалпакстан|Навоийская область|Наманганская область|Самаркандская область| Сырдарьинская область|Сурхандарьинская область|Ташкентская область|Ферганская область|Хорезмская область', function($bot){
        $bot->typesAndWaits(0);
        $bot->reply('');
        $keyboard = [
            ['Завершение'],
        ...
        $bot->reply("Если у вас есть какая-либо информация в этом направлении (видео / аудио / фото / и т. Д.), Вы можете прислать ее нам с приложением!", ['reply_markup' => json_encode([
            'keyboard' => $keyboard,
            'one_time_keyboard' => true,
            'resize_keyboard' => true
        ])]);
    ...
    $botman->hears('Ўзбекистон Республикаси қишлоқ хўжалиги вазирлиги|
    Қорақалпоғистон Республикаси қишлоқ хўжалиги вазирлиги|
    Андижон вилояти қишлоқ хўжалиги бошқармаси|
    Фарғона вилояти қишлоқ хўжалиги бошқармаси|
    Жиззах вилояти қишлоқ хўжалиги бошқармаси|
    ...
    Андижон қишлоқ хўжалиги ва агротехнологиялар институти|
    Маъмурий-хўжалик хизмати муассасаси|
    Агросаноатни рақамлаштириш маркази', function($bot){
        $bot->typesAndWaits(0);
        $bot->reply('');
        $keyboard = [
            ['Якунлаш'],
    ...
    $botman->hears('Завершение', function($bot){
        $bot->typesAndWaits(0);
        $bot->reply('');
        $keyboard = [
        ['Провинции'],
        ...
        $bot->reply("✅Ваше сообщение будет рассмотрено в установленном порядке. Спасибо за информацию!", ['reply_markup' => json_encode([
            'keyboard' => $keyboard,
            'one_time_keyboard' => true,
            'resize_keyboard' => true
        ])]);
